      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow">
          ...
          <div className="p-6">
            ...
            <p className="text-sm text-muted-foreground">
              Upload dense, multi-page PDFs and chat with them. A FastAPI ingestion pipeline parses
              each page, chunks it, and embeds it into Postgres with pgvector under an HNSW index;
              questions retrieve the top matching chunks and stream a Gemini-grounded answer over
              SSE, cited down to the page, and refuse to answer when nothing clears the similarity
              threshold
            </p>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <span className="rounded-sm bg-muted px-2 py-1 text-xs">PostgreSQL</span>
              ...
              <span className="rounded-sm bg-muted px-2 py-1 text-xs">TypeScript</span>
            </div>
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow">
          ...
          <div className="p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <span className="rounded-sm bg-muted px-2 py-1 text-xs">Flask</span>
              <span className="rounded-sm bg-muted px-2 py-1 text-xs">Full Stack</span>
              <span className="rounded-sm bg-muted px-2 py-1 text-xs">MariaDB</span>
              <span className="rounded-sm bg-muted px-2 py-1 text-xs">React</span>
